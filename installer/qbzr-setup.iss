...
AppId=QBzr
AppName=QBzr
AppVerName=QBzr 0.14.2

OutputBaseFilename=qbzr-setup-0.14.2
SourceDir="..\"
OutputDir="."
...
ExtraLibs=Additional libraries (PyQt4, Pygments, etc.)

russian.NormalInstallation=Обычная установка
russian.FullInstallation=Полная установка
russian.CustomInstallation=Выборочная установка
russian.MainFiles=Основные файлы
russian.ExtraLibs=Дополнительные библиотеки (PyQt4, Pygments и т.д.)
...
[Components]
Name: "main"; Description: {cm:MainFiles}; Types: full normal custom
Name: "libs"; Description: {cm:ExtraLibs}; Types: full custom

[Files]
Source: "__init__.py"; DestDir: {app}; Components: main
Source: "lib\*.py"; DestDir: {app}\lib; Flags: recursesubdirs; Components: main
