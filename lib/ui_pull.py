...
class Ui_PullForm(object):
    def setupUi(self, PullForm):
        ...
        PullForm.resize(420,131)
        self.gridLayout = QtGui.QGridLayout(PullForm)
        self.gridLayout.setObjectName("gridLayout")
        self.label_2 = QtGui.QLabel(PullForm)
        self.label_2.setObjectName("label_2")
        self.gridLayout.addWidget(self.label_2,0,0,1,1)
        self.location = QtGui.QComboBox(PullForm)
        ...
        self.location_picker = QtGui.QPushButton(PullForm)
        self.location_picker.setObjectName("location_picker")
        self.gridLayout.addWidget(self.location_picker,0,3,1,1)
        self.label_3 = QtGui.QLabel(PullForm)
        self.label_3.setObjectName("label_3")
        self.gridLayout.addWidget(self.label_3,1,0,1,1)
        self.revision = QtGui.QLineEdit(PullForm)
    ...
    def retranslateUi(self, PullForm):
        PullForm.setTitle(gettext("Options"))
